...
async def start(client: Pr0fess0r_99, update):
    start_msg = "👋HOOI {}, Iam Simple Auto Welcome Bot\n\nBot Owner Only /admin\n\nMaintained By @SHIRO_BOT_SUPPORT"
        ...
        [             
            [
                InlineKeyboardButton
                    (
                         "🤖More Bots", url="t.me/SHIRO_BOT_SUPPORT"
                    ),
                InlineKeyboardButton
                    (
                         "💡Open Source", url="https://t.me/MRGBOTREPAIR/10"
                    )
            ],   
            [
                InlineKeyboardButton
    ...
    deploy =InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton
                    (
                        "💫 OWNNER 💫", url=f"https://t.me/charmyanime"
                    )
            ]
        ]
    )
...
async def auto_welcome(bot: Pr0fess0r_99, msg: Message):
    ...
    link_button = "t.me/SHIRO_BOT_SUPPORT"
